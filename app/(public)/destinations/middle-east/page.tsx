...
const HUBS: Hub[] = [
  {
    ...
    rates: {
      split: "Earnings depend on demand/client",
      shot: "1-2 hours: $250",
  ...
  },
{
    ...
    subtitle: { EN: "Party & Tourist Hub", RU: "Тусовочный и туристический центр" },
    description: {
      EN: "A fast-paced, high-earning destination. Non-Muslim country with a vibrant tourist flow, energetic parties, and generous clientele.",
      RU: "Динамичное направление с высоким заработком. Не мусульманская страна с активным туристическим потоком, тусовками и щедрыми клиентами."
    },
    rates: {
      split: "50/50 (earnings & expenses)",
      shot: "30m: $100 - $150",
      incall: "1h: $200",
      outcall: "Out: $250 / Night (6h): $1000 - $1200",
    },
    accommodation: {
      EN: "Apartments ($50-60/day, split 50/50). Solo or with a friend. Ticket costs split 50/50 for full 14-day tour.",
      RU: "Апартаменты (50-60$ в сутки, оплата 50/50). Проживание по 1-2 человека. Билет 50/50 при отработке полного тура (14 дней)."
    },
    services: {
      EN: "Work hours: 15:00 - 03:00. Minimum tour: 14 days. Cash only. Taxi paid by client.",
      RU: "График: 15:00 - 03:00. Мин. тур: 14 дней. Оплата только наличными. Такси за счет клиента."
    },
    x: 52,
    y: 2,
  },
  {
    ...
    subtitle: { EN: "Calm & Generous", RU: "Спокойствие и щедрость" },
    description: {
      EN: "A comfortable and hospitable market with massive local advertising. Loyal regular clients and a relaxed, secure atmosphere.",
      RU: "Комфортный и гостеприимный рынок с масштабной рекламой. Лояльные постоянные клиенты и спокойная, безопасная атмосфера."
    },
    rates: {
      split: "50/50 (earnings & expenses)",
      shot: "30m: $100 - $150",
      incall: "1h: $200 - $250",
      outcall: "Night: $1000 - $1500 (Tips & extras 100% yours)",
    },
    accommodation: {
      EN: "Private comfortable apartments (split 50/50). Option to live with a friend. Flight crediting available.",
      RU: "Комфортные отдельные апартаменты (оплата 50/50). Возможно жить с подругой. Кредитация билетов, оплата 50/50."
    },
    services: {
      EN: "Minimum tour 2 weeks. 24/7 operator support. Constant photo updates required for maximum demand.",
      RU: "Мин. тур 2 недели. Поддержка операторов 24/7. Необходимы постоянные обновления фото для высоких заработков."
    },
    x: 52,
    y: 6,
  },
  {
    id: "cyprus_greek",
    name: { EN: "CYPRUS (GREEK)", RU: "КИПР (ГРЕЧЕСКИЙ)" },
    subtitle: { EN: "Elite Seaside Hub", RU: "Элитный прибрежный хаб" },
    description: {
      EN: "Premium locations including Limassol, Nicosia, Ayia Napa, and Larnaca. High-end seaside tours with an exclusive clientele.",
      RU: "Премиальные локации: Лимассол, Никосия, Айя-Напа и Ларнака. Элитные туры у моря с эксклюзивной клиентурой."
    },
    rates: {
      split: "60/40",
      shot: "30m: $150 / 1h: $250 (MBR included)",
      incall: "Tour across cities available",
      outcall: "On demand",
    },
    accommodation: {
      EN: "4* Hotels (~100 EUR/day). Expenses split 50/50.",
      RU: "Отели 4* (~100 евро/сутки). Расходы делятся 50/50."
    },
    services: {
      EN: "Professional photo sets are highly recommended for higher demand. Type-based selection also considered.",
      RU: "Хороший фотосет является большим плюсом для спроса. Возможна работа по типажам."
    },
    x: 23,
    y: 23,
  },
  {
    id: "cyprus_turkish",
    name: { EN: "CYPRUS (TURKISH)", RU: "КИПР (ТУРЕЦКИЙ)" },
    subtitle: { EN: "VIP Club Scene", RU: "Закрытая VIP-сцена" },
    description: {
      EN: "Fully legal casino hub like Las Vegas. 100% safe, no internet ads, absolute discretion. Elite clients: bankers, businessmen, and VIP casino players.",
      RU: "Полностью легальный игровой хаб уровня Лас-Вегаса. 100% безопасность, никакой рекламы в сети, абсолютная конфиденциальность. Элитные клиенты: банкиры, бизнесмены, игроки VIP-казино."
    },
    rates: {
      split: "40/60 (Girl 40% / Club 60%)",
      shot: "Consumation: $30",
      incall: "Hourly: $130 - $250",
      outcall: "Escort: $300 - $500 (Tips 100% yours)",
    },
    accommodation: {
      EN: "Free comfortable solo accommodation provided and fully paid by the VIP club.",
      RU: "Бесплатное комфортное жилье (проживание по одной) полностью за счет VIP-клуба."
    },
    services: {
      EN: "Official work visa (2-6 months) & medical insurance. Club hours: 20:00-01:00. Strict face control, photo/video forbidden.",
      RU: "Официальная рабочая виза (2-6 мес) и медстраховка. График: 20:00-01:00. Строгий фейс-контроль, съемка строго запрещена."
    },
    x: 27,
    y: 22,
  }
            ...
            <div className="lg:col-span-7">
              ...
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-zinc-800/60 bg-zinc-950 shadow-2xl">
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" style={STAGE_STYLE}>
                  <Image src="/map-mena.jpg" alt="MENA Map" fill priority className="object-cover opacity-80" />
                ...
                <div className="absolute top-6 left-6 z-10 pointer-events-none">
                  <span className="font-serif text-5xl font-light text-zinc-100/10 select-none tracking-widest">MENA</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <>
            ...
            >
              ...
              <div className="space-y-8">
                <div className="text-sm font-light leading-relaxed text-zinc-400">{selected.description[lang]}</div>
                <div>
